...
export const STATUS_TRANSITIONS: Record<string, Set<string>> = {
  pending: new Set(['confirmed', 'returned']),
  returned: new Set(['pending']),
  confirmed: new Set(['pool']),
  pool: new Set(['producing']),
  producing: new Set(['shipped']),
...
export const productionTaskDraftSchema = z.object({
  ...
  handleless: z.string().optional().default('无'),
...
export const orderFormSchema = z.object({
  ...
  to_tenant_id: z.string().optional().default(''),
  target_factory_id: z.string().optional().default(''),
  parent_order_id: z.string().optional().default(''),
  existing_order_id: z.string().optional().default(''),
  customer_name: z.string().min(1, '订单名称不能为空'),
