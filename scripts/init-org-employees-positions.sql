...
CREATE UNIQUE INDEX IF NOT EXISTS employees_unique_tenant_user_idx ON employees(tenant_id, user_id);
CREATE UNIQUE INDEX IF NOT EXISTS employees_unique_tenant_phone_idx ON employees(tenant_id, phone);
CREATE UNIQUE INDEX IF NOT EXISTS employees_unique_tenant_employee_no_idx ON employees(tenant_id, employee_no);
